...
A very rough guide on how to use the microphones and create a personal target can be found [here](link/link.md). Please expect the results to be confusing and problematic if you start this project. 
